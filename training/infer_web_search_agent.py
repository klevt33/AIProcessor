...
output_file = "llm_websearch_test_data_output1.xlsx"
...
async def test_llm_websearch_stage(description):
    ...
    print("websearch_stage_details: ", websearch_stage_details.details)
...
async def process_row(row):
    async with semaphore:
        ...
        result = await test_llm_websearch_stage(row["ITM_LDSC_CLEAN"])
        ...
        return {
            ...
            "source": result.get("web_search_url"),
